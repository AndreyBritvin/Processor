...
HEADERS_INCLUDE = -Iinclude -I../Stack/include
...
a.out: build/main.o build/my_processor.o ../Stack/build/my_stack.o ../Stack/build/my_stack_protection.o ../Stack/build/my_stack_print.o
	@$(CC) $(CFLAGS) build/main.o build/my_processor.o build/my_stack.o build/my_stack_protection.o build/my_stack_print.o
...
build/my_processor.o: src/my_processor.cpp include/my_processor.h
...
comp_file:
	g++ src/my_assembler.cpp -o asm.out -Iinclude
	./asm.out
